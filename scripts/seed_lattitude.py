...
def seed_lattitude():
    ...
    try:
        ...
        # Hash password
        salt = bcrypt.gensalt()
        password_hash = bcrypt.hashpw("Lattitude2026!".encode('utf-8'), salt).decode('utf-8')

        symmetri_id = "@lattitude" + str(uuid.uuid4())[:4]
