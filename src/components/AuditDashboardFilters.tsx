  ...
  return (
    <section className="mb-4 space-y-2 text-sm">
      ...
      <div className="grid grid-cols-2 gap-2 mt-2">
        <input id="from-date" type="date" value={filters.dateRange.from} onChange={(e) => updateFilter('dateRange', { from: e.target.value })} placeholder="From" />
        <input id="to-date" type="date" value={filters.dateRange.to} onChange={(e) => updateFilter('dateRange', { to: e.target.value })} placeholder="To" />
      </div>
    </section>
  );
}